...
def select_features(
    ...
    *,
    ...
    """
    folds = dict(group_column=group_column, time_column=time_column, period_column=period_column,
                presets=presets, sample_weight=sample_weight)  # same strategy/config as reported CV
